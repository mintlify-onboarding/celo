...
<Tip>
  While many commands will be the same, you may need to follow the instructions
  for your specific OS when installing software. The Celo docs have some
  resources for [Windows development](/developer/setup/windows).
</Tip>
...
## Web2 Prerequisites[](#web2-prerequisites "Direct link to heading")

### Xcode[](#xcode "Direct link to heading")
...
### Node, NPM and NVM[](#node-npm-and-nvm "Direct link to heading")
...
### NPM[](#npm "Direct link to heading")
...
### NVM[](#nvm "Direct link to heading")
...
#### Install Node and npm via nvm[](#install-node-and-npm-via-nvm "Direct link to heading")
...
<Info>You can switch node versions using</Info>
...
### Yarn[](#yarn "Direct link to heading")
...
#### Install yarn[](#install-yarn "Direct link to heading")
...
<Info>
  The `-g` is short for `--global`. This flag means you are installing this
  package on your system and it will be accessible from the cli no matter what
  project you are in.
</Info>
...
#### Install Expo[](#install-expo "Direct link to heading")
...
### Docker[](#docker "Direct link to heading")
...
#### Install Docker[](#install-docker "Direct link to heading")
...
## Celo Prerequisites[](#celo-prerequisites "Direct link to heading")

### Truffle[](#truffle "Direct link to heading")
...
### Local Development Blockchain[](#local-development-blockchain "Direct link to heading")
...
### Celo CLI[](#celo-cli "Direct link to heading")
...
<Info>
  Installation can take over a minute, so be patient depending on your internet
  connection.
</Info>

### Celo Wallet[](#celo-wallet "Direct link to heading")
...
<Tip>
  Celo's focus on mobile-first means that the priority has been on mobile
  applications and tooling. We know there is a growing demand for web
  applications and have several projects underway to build the tools needed to
  support web-based applications. In the meantime, you can still use your
  web-savvy skills to develop mobile apps without too much of a learning curve
  because of frameworks like React Native and Expo.
</Tip>

### Celo Wallet Prerequisites[](#celo-wallet-prerequisites "Direct link to heading")

#### Watchman[](#watchman "Direct link to heading")
...
#### Xcode[](#xcode-1 "Direct link to heading")
...
#### Android Dev Tools[](#android-dev-tools "Direct link to heading")
...
<Info>
  These paths may differ on your machine. You can find the path to the SDK and
  NDK via the [Android Studio
  menu](https://stackoverflow.com/questions/40520324/how-to-find-the-path-to-ndk).
</Info>
...
#### Android Emulator[](#android-emulator "Direct link to heading")
...
Under OSX High Sierra and later, you'll get a message that you need to [approve it in System Preferences > Security & Privacy > General.](https://developer.apple.com/library/content/technotes/tn2459/%5Findex.html)
...
### Extras[](#extras "Direct link to heading")

#### Solidity support for VSCode[](#solidity-support-for-vscode "Direct link to heading")
