...
### Developing with WSL[](#developing-with-wsl "Direct link to heading")
...
### Additional Resources[](#additional-resources "Direct link to heading")

* [**Windows Subsystem for Linux Installation Guide for Windows 10**](https://docs.microsoft.com/en-us/windows/wsl/install-win10?WT.mc%5Fid=smashingmag-article-buhollan)
