...
description: "How to create and fund a testnet wallets to use for developing Celo dApps."
---
...
<Tip>This guide will focus on funding an account on MetaMask with Celo ([Alfajores testnet](/network) tokens). You can also use the [Celo Extension Wallet](/wallet) if you prefer. Additionally, you can fund your wallet with real Celo if you would like to deploy to the Celo mainnet.</Tip>

## Download a Wallet[](#download-a-wallet "Direct link to heading")
...
## Create your Account[](#create-your-account "Direct link to heading")
...
### Using a wallet[](#using-a-wallet "Direct link to heading")
...
<Tip>Skip to [this step](#fund-your-account) to fund your account.</Tip>

### Using Ganache[](#using-ganache "Direct link to heading")
...
#### Install Ganache[](#install-ganache "Direct link to heading")
...
#### Start Ganache[](#start-ganache "Direct link to heading")
...
![ganache terminal output](/images/image4-8a081df02852df5a910c26403914e264.png)

<Tip>Skip to [this step](#import-account-to-wallet-for-options-2--3) to connect your accounts to your wallet.</Tip>

### Using Celo CLI[](#using-celo-cli "Direct link to heading")
...
#### Create an Account[](#create-an-account "Direct link to heading")
...
## Import Account to Wallet (for Options 2 & 3)[](#import-account-to-wallet-for-options-2--3 "Direct link to heading")
...
## Fund your Account[](#fund-your-account "Direct link to heading")
...
![alfajores faucet](/images/image6-5f44484304e29a836feabb0280221800.png)
