...
sidebarTitle: "Local Chain"
description: "How to set up a Celo development blockchain that includes all of the [core protocol contracts](https://github.com/celo-org/celo-monorepo/tree/master/packages/protocol), including identity and stability contracts."
---

## What to expect[](#what-to-expect "Direct link to heading")
...
### Use Ganache to fork Mainnet or Alfajores[](#use-ganache-to-fork-mainnet-or-alfajores "Direct link to heading")
...
### Use the celo-devchain NPM package[](#use-the-celo-devchain-npm-package "Direct link to heading")
...
### Initialize your own devchain from the monorepo[](#initialize-your-own-devchain-from-the-monorepo "Direct link to heading")
...
## Interacting with the chain[](#interacting-with-the-chain "Direct link to heading")

### **Inspecting the chain**[](#inspecting-the-chain "Direct link to heading")
...
The CLI will connect to the node at [http://localhost:8545](http://localhost:8545) by default. To connect to port 7545 you can run`$ celocli config:set -n http://localhost:7545`, and then check the connection by running `$ celocli node:get`.
...
### ContractKit + Node.js[](#contractkit--nodejs "Direct link to heading")
...
### Using Ethereum developers tools with Celo[](#using-ethereum-developers-tools-with-celo "Direct link to heading")
