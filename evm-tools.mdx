...
## New developers start here[](#new-developers-start-here "Direct link to heading")
...
## Developing Smart Contracts[](#developing-smart-contracts "Direct link to heading")

### Smart Contract Languages[](#smart-contract-languages "Direct link to heading")
...
### IDEs[](#ides "Direct link to heading")
...
## Other tools[](#other-tools "Direct link to heading")
...
## Test Blockchain Networks[](#test-blockchain-networks "Direct link to heading")
...
- [Local Ethereum Network](https://github.com/ConsenSys/local%5Fethereum%5Fnetwork) \- Out-of-the-box deployment scripts for private PoW networks
...
### Test Ether Faucets[](#test-ether-faucets "Direct link to heading")
...
## Communicating with Ethereum[](#communicating-with-ethereum "Direct link to heading")

### Frontend Ethereum APIs[](#frontend-ethereum-apis "Direct link to heading")
...
### Backend Ethereum APIs[](#backend-ethereum-apis "Direct link to heading")
...
- [EthContract](https://github.com/AgileAlpha/eth%5Fcontract) \- A set of helper methods to help query ETH smart contracts in Elixir
...
### Bootstrap/Out-of-Box tools[](#bootstrapout-of-box-tools "Direct link to heading")
...
### Ethereum ABI (Application Binary Interface) tools[](#ethereum-abi-application-binary-interface-tools "Direct link to heading")
...
### Patterns & Best Practices[](#patterns--best-practices "Direct link to heading")

#### Patterns for Smart Contract Development[](#patterns-for-smart-contract-development "Direct link to heading")
...
- [Dappsys: Safe, simple, and flexible Ethereum contract building blocks](https://github.com/dapphub/dappsys)
  - has solutions for common problems in Ethereum/Solidity, eg.  
     _ [Whitelisting](https://steemit.com/ethereum/@nexusdev/dapp-a-day-11-whitelist-boring)  
     _ [Upgradable ERC20-Token](https://steemit.com/ethereum/@nikolai/dapp-a-day-6-upgradeable-tokens)  
     _ [ERC20-Token-Vault](https://steemit.com/ethereum/@nexusdev/dapp-a-day-18-erc20-token-vault)  
     _ [Authentication (RBAC)](https://steemit.com/ethereum/@nikolai/dapp-a-day-4-access-control-via-auth)  
...
#### Upgradeability[](#upgradeability "Direct link to heading")
...
## Infrastructure[](#infrastructure "Direct link to heading")

### Ethereum Clients[](#ethereum-clients "Direct link to heading")
...
## Testing Tools[](#testing-tools "Direct link to heading")
...
## Security Tools[](#security-tools "Direct link to heading")
...
## Other Miscellaneous Tools[](#other-miscellaneous-tools "Direct link to heading")
...
## Smart Contract Standards & Libraries[](#smart-contract-standards--libraries "Direct link to heading")

### [ERCs](https://eips.ethereum.org/erc) \- The Ethereum Request for Comment repository[](#ercs---the-ethereum-request-for-comment-repository "Direct link to heading")
...
### Popular Smart Contract Libraries[](#popular-smart-contract-libraries "Direct link to heading")
...
## Developer Guides for 2nd Layer Infrastructure[](#developer-guides-for-2nd-layer-infrastructure "Direct link to heading")

### Scalability[](#scalability "Direct link to heading")

### Payment/State Channels[](#paymentstate-channels "Direct link to heading")
...
### Plasma[](#plasma "Direct link to heading")
...
### Side-Chains[](#side-chains "Direct link to heading")
...
### Privacy / Confidentiality[](#privacy--confidentiality "Direct link to heading")

#### ZK-SNARKs[](#zk-snarks "Direct link to heading")
...
### Scalability + Privacy[](#scalability--privacy "Direct link to heading")

### ZK-STARKs[](#zk-starks "Direct link to heading")
...
### Prebuilt UI Components[](#prebuilt-ui-components "Direct link to heading")
...
Inspired by: [https://github.com/ConsenSys/ethereum-developer-tools-list](https://github.com/ConsenSys/ethereum-developer-tools-list)
