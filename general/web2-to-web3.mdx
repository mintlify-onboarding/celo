...
![](/images/general/web2-web3-4232599ef9cfa409eaebc143faa6b3d1.svg)

## Web2 Foundation[](#web2-foundation "Direct link to heading")
...
## Web3 Specific[](#web3-specific "Direct link to heading")
...
### EVM Blockchain Toolkit[](#evm-blockchain--toolkit "Direct link to heading")
...
### Web3 Helper Libraries (optional but helpful)[](#web3-helper-libraries-optional-but-helpful "Direct link to heading")
...
### Wallet Connection Manager[](#wallet-connection-manager "Direct link to heading")
...
## Differences[](#differences "Direct link to heading")
...
### Off Browser[](#off-browser "Direct link to heading")
