...
## Introduction to the Celo Stack[](#introduction-to-the-celo-stack "Direct link to heading")
...
## A Full-Stack Approach[](#a-full-stack-approach "Direct link to heading")
...
![](/images/general/full-stack-diagram.jpg)

## Celo Blockchain[](#celo-blockchain "Direct link to heading")
...
## Celo Core Contracts[](#celo-core-contracts "Direct link to heading")
...
## Celo Network Topology[](#celo-network-topology "Direct link to heading")
...
## Full Nodes[](#full-nodes "Direct link to heading")
...
## Light Clients[](#light-clients "Direct link to heading")
