...
## Introduction to Hardhat[](#introduction-to-hardhat "Direct link to heading")
...
## Create Hardhat Project[](#create-hardhat-project "Direct link to heading")
...
## Update the hardhat.config.js file[](#update-the-hardhatconfigjs-file "Direct link to heading")
...
### Connect to Local Network[](#connect-to-local-network "Direct link to heading")
...
<Tip>
  If you choose to [Set up a Local Development
  Chain](/developer/setup/development-chain), your blockchain will also be
  hosted on a private network on localhost. This same configuration can be used
  to connect to the local development chain.
</Tip>

### Connect to Testnet using Forno[](#connect-to-testnet-using-forno "Direct link to heading")
...
<Note>
  Celo uses a different account derivation path than Ethereum, so you have to
  specify "m/44'/52752'/0'/0" as the path.
</Note>

### Connect to Mainnet using Forno[](#connect-to-mainnet-using-forno "Direct link to heading")
...
## Deploy to Celo[](#deploy-to-celo "Direct link to heading")
...
![github](/images/image1-5806680bc053bfd0146c0d479a48f8cf.png)

<Tip>
  Learn more about building and deploying dApps using the [HardHat
