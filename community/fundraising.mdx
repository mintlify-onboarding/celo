...
## Expert Resources[](#expert-resources "Direct link to heading")
...
## Raising Capital[](#raising-capital "Direct link to heading")

### When should I start thinking about raising capital?[](#when-should-i-start-thinking-about-raising-capital "Direct link to heading")
...
### What do I need to research before starting my fundraise?[](#what-do-i-need-to-research-before-starting-my-fundraise "Direct link to heading")
...
1. Ensure that the investors you identify are actively investing. For example, try finding investors who have made 1-2 relevant investments within the last 2-4 months using the databases below.
2. Once you’ve identified a subset of investors who may be a fit for your sector/geography/stage, aggregate a list in your personal database to stay organized. Some popular tools include pre-built templates on [Airtable](https://www.airtable.com/templates/entrepreneurship/expQrNqXl4bUBrb8B/fundraising-crm) or even creating your own tracker on Google Sheets. As your number of conversations grows, it’s important to keep track of the status of each conversation and to understand where you should be doubling efforts to increase your chances of success.
3. If one of your target investors is a venture capital fund, take some time to look through their website as well to look for a few things
...
### How much capital do I need to raise?[](#how-much-capital-do-i-need-to-raise "Direct link to heading")
...
### What are the different forms of capital I can raise?[](#what-are-the-different-forms-of-capital-i-can-raise "Direct link to heading")
...
1. **SAFE + Token Warrants** \- A combination of a SAFE and a token warrant has become increasingly popular for fundraising in Web3\. Unlike SAFTs, these token warrants typically come in the form of an optional side letter and don’t guarantee the deployment of tokens - therefore avoiding the legal complications faced by its predecessor. As a result, companies are more commonly raising capital on SAFEs along with a token warrant that offers investors the right to tokens in the amount that can be proportional to their equity ownership of the company. In this manner, investors have exposure to both equity and potential tokens if the companies decide to launch one.  
   * The team at LiquiFi has written an excellent piece on the topic and provides a practical guidance for token allocation. [https://medium.com/@liquifi\_finance/crypto-web3-fundraising-with-token-side-letters-or-token-warrants-33dce66f375e](https://medium.com/@liquifi%5Ffinance/crypto-web3-fundraising-with-token-side-letters-or-token-warrants-33dce66f375e).  
   * This resource from Cooopahtroopa and Lauren Stephanian is also a must read for entrepreneurs who need to understand historical and current benchmarks on tokenomics. [https://lstephanian.mirror.xyz/kB9Jz\_5joqbY0ePO8rU1NNDKhiqvzU6OWyYsbSA-Kcc](https://lstephanian.mirror.xyz/kB9Jz%5F5joqbY0ePO8rU1NNDKhiqvzU6OWyYsbSA-Kcc).
2. **Equity** \- Equity rounds allow companies to set an official valuation for the company and to issue shares to investors at a specific price. Over time, these rounds are generally reserved for Series A and later stage companies. Companies at the seed stage have raised priced rounds historically, although more of them are raising on SAFEs at the earlier stages for the speed of putting operating capital to work.

### What should I have prepared for investor conversations?[](#what-should-i-have-prepared-for-investor-conversations "Direct link to heading")
...
### What do I need in my investor presentation?[](#what-do-i-need-in-my-investor-presentation "Direct link to heading")
...
The team at NFX has put together a [comprehensive sample pitch deck](https://docs.google.com/presentation/d/1k7Ci129LjMdrV9OPkHUpWHqn%5FCsVdaEkd1RhU9G%5FCx4/edit#slide=id.gabb84e51a1%5F0%5F1278) with relevant examples of slides of pitch decks from other companies.
...
### Pitching Process[](#pitching-process "Direct link to heading")
...
### Post Investment[](#post-investment "Direct link to heading")
...
## Celo Ecosystem Investors[](#celo-ecosystem-investors "Direct link to heading")

### Who should I go to within the Celo Ecosystem?[](#who-should-i-go-to-within-the-celo-ecosystem "Direct link to heading")
...
![fundraising](/images/community/1-e999a6ee6184b48e753c5e4154843dc0.png)

## Celo Camp[](#celo-camp "Direct link to heading")
...
## Celo Web3 Studio (via Bld.ai)[](#celo-web3-studio-via-bldai "Direct link to heading")
...
## Celo Community Fund\[Closed\][](#celo-community-fundclosed "Direct link to heading")
...
## Prezenti[](#prezenti "Direct link to heading")
...
## Celo Foundation Grant Program[](#celo-foundation-grant-program "Direct link to heading")
...
## Celo Scout Investors[](#celo-scout-investors "Direct link to heading")
...
## Dedicated Institutional Celo Ecosystem Funds[](#dedicated-institutional-celo-ecosystem-funds "Direct link to heading")
...
![fundraising](/images/community/2-85a2256fe4209446e62e1b8b0fa25230.png)

### Flori Ventures[](#flori-ventures "Direct link to heading")
...
### Unicorn Growth Fund[](#unicorn-growth-fund "Direct link to heading")
...
**Stage Focus:** Seed & Series A**Geography Focus:** Africa**Sector Focus:** FinTech & DeFi Infrastructure, Embedded Finance, Financial Services**Average Check Size:** $500K for Seed and <$1.5M for Series A

### Lightshift Capital[](#lightshift-capital "Direct link to heading")
...
### TKX Digital Group[](#tkx-digital-group "Direct link to heading")
...
### Polychain Fund[](#polychain-fund "Direct link to heading")
...
## Other Prominent Celo Ecosystem Investors:[](#other-prominent-celo-ecosystem-investors "Direct link to heading")
...
![fundraising](/images/community/3-605eed6fca2ddb1b32acfecf3ed46080.png)

## How do I get in touch with these investors?[](#how-do-i-get-in-touch-with-these-investors "Direct link to heading")
