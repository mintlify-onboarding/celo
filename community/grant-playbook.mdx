...
## Code of Conduct[](#code-of-conduct "Direct link to heading")
...
## Communication Guidelines[](#communication-guidelines "Direct link to heading")

### Social Media Engagement[](#social-media-engagement "Direct link to heading")
...
### Blog[](#blog "Direct link to heading")
...
## Engagement & Documentation[](#engagement--documentation "Direct link to heading")

### Source Code[](#source-code "Direct link to heading")

In the spirit of decentralization, The Celo Foundation expects all funded projects to be open-source by default -- this means that the codebase is public and under a permissive license (we recommend [Apache 2.0](https://wikipedia.org/wiki/Apache%5FLicense)). If there are any parts that need to be kept private (eg. an admin key), please let us know ahead of time (at [grants@celo.org](mailto:grants@celo.org)), and document it in your project’s README.

To make sure teams are making progress on projects, send us bi-weekly updates to [grants@celo.org.](mailto:grants@celo.org.) The intent is not to create pressure, but to provide structure and guidance in case things get off track. Some suggestions:
...
### Chat[](#chat "Direct link to heading")
...
### Office Hours via Video Chat[](#office-hours-via-video-chat "Direct link to heading")
...
## Milestone Reviews & Payment[](#milestone-reviews--payment "Direct link to heading")
...
## Evaluating Grant Success[](#evaluating-grant-success "Direct link to heading")
