...
## How to Contribute[](#how-to-contribute "Direct link to heading")
...
## Contributor Guidelines[](#contributor-guidelines "Direct link to heading")
...
## Submitting PRs[](#submitting-prs "Direct link to heading")
...
## 🖥️ Code[](#️-code "Direct link to heading")
...
#### Please make sure your PR[](#please-make-sure-your-pr "Direct link to heading")
...
#### Please make sure your issue[](#please-make-sure-your-issue "Direct link to heading")
...
## 🤝 CIPs[](#-cips "Direct link to heading")
...
#### Submitting CIPs[](#submitting-cips "Direct link to heading")
...
#### CIP template[](#cip-template "Direct link to heading")
...
## 📄 Docs[](#-docs "Direct link to heading")
...
[Watch the Video ↗️](https://www.youtube.com/watch?v=DaAenTNv668&feature=emb%5Ftitle)

#### Edit an existing page[](#edit-an-existing-page "Direct link to heading")
...
#### Add/remove pages[](#addremove-pages "Direct link to heading")
...
#### File naming[](#file-naming "Direct link to heading")
...
#### Front Matter[](#front-matter "Direct link to heading")
...
#### Post summary[](#post-summary "Direct link to heading")
...
#### Adding static assets[](#adding-static-assets "Direct link to heading")
...
## 🌐 Translations[](#-translations "Direct link to heading")
...
#### How to Contribute[](#how-to-contribute-1 "Direct link to heading")
