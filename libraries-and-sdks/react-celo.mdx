...
## react-celo[](#react-celo-1 "Direct link to heading")
...
## Supported wallets[](#supported-wallets "Direct link to heading")
...
## Basic Usage[](#basic-usage "Direct link to heading")

### Wrap your application with CeloProvider[](#wrap-your-application-with-celoprovider "Direct link to heading")
...
### Default wallets and customization[](#default-wallets-and-customization "Direct link to heading")
...
### Prompt users to connect their wallet[](#prompt-users-to-connect-their-wallet "Direct link to heading")
...
### Use ContractKit to read chain data[](#use-contractkit-to-read-chain-data "Direct link to heading")
...
### Accessing user accounts[](#accessing-user-accounts "Direct link to heading")
...
#### Last connected account[](#last-connected-account "Direct link to heading")
...
#### Get a connected account[](#get-a-connected-account "Direct link to heading")
...
### Network management[](#network-management "Direct link to heading")
...
#### walletChainId vs network[](#walletchainid-vs-network "Direct link to heading")
...
#### Extending Supported Networks[](#extending-supported-networks "Direct link to heading")
...
#### Manual Networking Mode[](#manual-networking-mode "Direct link to heading")
...
### Adjust FeeCurrency[](#adjust-feecurrency "Direct link to heading")
...
### Themes and dark-mode[](#themes-and-dark-mode "Direct link to heading")
...
### Logging and debugging[](#logging-and-debugging "Direct link to heading")
...
### Guides[](#guides "Direct link to heading")
