...
## Interacting with CELO & cUSD[](#interacting-with-celo--cusd "Direct link to heading")
...
## Interacting with Other Celo Contracts[](#interacting-with-other-celo-contracts "Direct link to heading")
...
## A Note About Contract Addresses[](#a-note-about-contract-addresses "Direct link to heading")
...
## Accessing web3 contract wrappers[](#accessing-web3-contract-wrappers "Direct link to heading")
...
## Debugging[](#debugging "Direct link to heading")
