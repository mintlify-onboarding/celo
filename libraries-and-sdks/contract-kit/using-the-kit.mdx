---
title: "Using the Kit"
description: "The following are some examples of the capabilities of the `ContractKit`, assuming it is already connected to a node. If you aren't connected, [here is a refresher.](/blog/developer-guide/start/hellocontracts)"
---

## Setting Default Tx Options[](#setting-default-tx-options "Direct link to heading")
...
## Set `feeCurrency` for a transaction[](#set-feecurrency-for-a-transaction "Direct link to heading")
...
## Getting the Total Balance[](#getting-the-total-balance "Direct link to heading")
...
## Deploy a contract[](#deploy-a-contract "Direct link to heading")
...
## Sending Custom Transactions[](#sending-custom-transactions "Direct link to heading")
...
## Selling CELO only if the rate is favorable[](#selling-celo-only-if-the-rate-is-favorable "Direct link to heading")
...
## Buying all the CELO I can, with the cUSD in my account[](#buying-all-the-celo-i-can-with-the-cusd-in-my-account "Direct link to heading")
