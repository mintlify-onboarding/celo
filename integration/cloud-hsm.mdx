...
## Introduction to HSM[](#introduction-to-hsm "Direct link to heading")
...
## Create an Azure subscription[](#create-an-azure-subscription "Direct link to heading")
...
## Deploy your Azure Key Vault[](#deploy-your-azure-key-vault "Direct link to heading")
...
## Create your key[](#create-your-key "Direct link to heading")
...
## Create a Service Principal[](#create-a-service-principal "Direct link to heading")
...
## Grant your Service Principal access to the key[](#grant-your-service-principal-access-to-the-key "Direct link to heading")
...
## Connecting CeloCLI to KeyVault[](#connecting-celocli-to-keyvault "Direct link to heading")
...
## Connecting ContractKit to KeyVault[](#connecting-contractkit-to-keyvault "Direct link to heading")
