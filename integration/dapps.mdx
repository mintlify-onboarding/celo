...
description: "Integrate with the Celo ecosystem to extend the functionality of your dApps."
---

## **🌱 Impact**[](#-impact "Direct link to heading")
...
## **💰 Saving**[](#-saving "Direct link to heading")
...
## **📡 Oracles**[](#-oracles "Direct link to heading")
...
- [Docs](https://github.com/redstone-finance/redstone-node/blob/main/docs/COMPILED%5FORACLE%5FDOCS.md)
...
## **💱 Exchanges**[](#-exchanges "Direct link to heading")
...
## **🏦 Lending Markets**[](#-lending-markets "Direct link to heading")
...
## **🤑 Yield Chasers**[](#-yield-chasers "Direct link to heading")
...
## **🆔 Identity**[](#-identity "Direct link to heading")
...
## **🌉 Bridges**[](#-bridges "Direct link to heading")
...
## 💵 Cash-in/out[](#-cash-inout "Direct link to heading")
...
## 🌐 DAOs[](#-daos "Direct link to heading")
...
- [Contracts](https://github.com/talentprotocol/contracts)
  - Relevant function calls  
     _ Read: stakes (supporter - talent token relationships), total supply, available minting  
     _ Write: create talent token, stake, claim rewards, unstake
- [About us](https://www.notion.so/talentprotocol/Talent-Protocol-101-26a6c4b9f8284e5e8f55603a38629e76)

## **📱 Social**[](#-social "Direct link to heading")
