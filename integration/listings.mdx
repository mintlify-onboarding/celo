...
## Celo Brand Assets for Listing[](#celo-brand-assets-for-listing "Direct link to heading")
...
## How To's[](#how-tos "Direct link to heading")

### Integrating Celo With Your Infrastructure[](#integrating-celo-with-your-infrastructure "Direct link to heading")
...
### Celo Native Asset and Stable Value Currencies[](#celo-native-asset-and-stable-value-currencies "Direct link to heading")
...
### Address for CELO and Stable Value Currencies[](#address-for-celo-and-stable-value-currencies "Direct link to heading")
...
### Useful API endpoints[](#useful-api-endpoints "Direct link to heading")
...
#### CELO and Stable Value Currencies[](#celo-and-stable-value-currencies "Direct link to heading")

##### Total CELO supply[](#total-celo-supply "Direct link to heading")
...
##### Stable Value Currencies[](#stable-value-currencies "Direct link to heading")

###### cUSD Circulating Supply[](#cusd-circulating-supply "Direct link to heading")
...
###### cEUR Circulating Supply[](#ceur-circulating-supply "Direct link to heading")

This endpoint is not yet available.

#### CP-DOTO (Stability Algorithm)[](#cp-doto-stability-algorithm "Direct link to heading")

CP-DOTO information can be found [here](/protocol/stability/doto).

For API endpoints useful for listing that follow [CMC requirements](https://docs.google.com/document/d/1S4urpzUnO2t7DmS%5F1dc4EL4tgnnbTObPYXvDeBnukCg/edit#)

##### Mento Addresses[](#mento-addresses "Direct link to heading")
...
##### Assets[](#assets "Direct link to heading")
...
##### Ticker[](#ticker "Direct link to heading")
...
##### Orderbook[](#orderbook "Direct link to heading")
...
##### CELO cUSD[](#celo-cusd "Direct link to heading")
...
### Whitepapers[](#whitepapers "Direct link to heading")
...
To learn more about the Stability Mechanism, you can find it over [here](/protocol/stability/doto). The [Stability Analysis Whitepaper](https://celo.org/papers/Celo%5FStability%5FAnalysis.pdf) and [blog post](https://medium.com/celohq/a-look-at-the-celo-stability-analysis-white-paper-part-1-23edd5ef8b5) will provide a lot more information on the stability algorithm.
...
### Audits[](#audits "Direct link to heading")
