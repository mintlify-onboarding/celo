---
title: "Custody"
descirption: "Details for custodians, exchanges, and other services that intend to custody Celo assets such as Celo Dollar and CELO on behalf of a user."
---

## Custody Overview[](#custody-overview "Direct link to heading")
...
## Balance Model[](#balance-model "Direct link to heading")
...
<Warning>
  Celo assets assets exist on an independent blockchain, and although they
  implement the ERC20 interface, they cannot be accessed through wallets that
  connect to the Ethereum network. Wallets and other integrations must connect
  to the Celo network to transfer tokens on Celo.
</Warning>

Applications that display balances may need to be written to be aware of this possibility.

## Transfers[](#transfers "Direct link to heading")
...
## CELO State Machine[](#celo-state-machine "Direct link to heading")
...
### Accounts[](#accounts "Direct link to heading")
...
### LockedGold[](#lockedgold "Direct link to heading")
...
### Election[](#election "Direct link to heading")
...
### ReleaseGold[](#releasegold "Direct link to heading")
...
## Other Balance Changing Operations[](#other-balance-changing-operations "Direct link to heading")
...
## Useful Tools[](#useful-tools "Direct link to heading")
