...
### Addresses[](#addresses "Direct link to heading")
...
### QR Codes[](#qr-codes "Direct link to heading")
...
## Custodian/Exchange[](#custodianexchange "Direct link to heading")

Please read more under [Custody](/integration/custody), but here is a shortened version:

### Detect Transfers[](#detect-transfers "Direct link to heading")
...
### Authorized Signers[](#authorized-signers "Direct link to heading")
...
### Release Gold[](#release-gold "Direct link to heading")
...
### Key Derivation[](#key-derivation "Direct link to heading")
...
### Identity Protocol[](#identity-protocol "Direct link to heading")
...
### Wallet Address[](#wallet-address "Direct link to heading")
...
### Transaction metadata[](#transaction-metadata "Direct link to heading")
...
## Validator Group Explorers[](#validator-group-explorers "Direct link to heading")
...
### Names[](#names "Direct link to heading")
...
### Identities[](#identities "Direct link to heading")
...
### Performance indicators[](#performance-indicators "Direct link to heading")
