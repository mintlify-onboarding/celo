...
## What is the Band Protocol?[](#what-is-the-band-protocol "Direct link to heading")
...
## Deploy Oracle[](#deploy-oracle "Direct link to heading")
...
![environment](/images/protocol/oracle/remix-environment.png)
...
![get price](/images/protocol/oracle/get-price.png)
...
![get prices](/images/protocol/oracle/getmultiprices.png)
...
![get prices](/images/protocol/oracle/saveprice.png)

## Mainnet Reference Data Contract[](#mainnet-reference-data-contract "Direct link to heading")
...
## Available Reference Data[](#available-reference-data "Direct link to heading")

You can view the available reference data on the [Band Data site here](https://data.bandprotocol.com/).

## Bandchain.js[](#bandchainjs "Direct link to heading")
