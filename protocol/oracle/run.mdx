---
title: "Running oraclesGetting started"
---
...
## Setting up the environment[](#setting-up-the-environment "Direct link to heading")
...
### Running with HSM[](#running-with-hsm "Direct link to heading")
...
### Using a private key[](#using-a-private-key "Direct link to heading")
...
### Setting up your keys in the node[](#setting-up-your-keys-in-the-node "Direct link to heading")
...
### Recommended configuration[](#recommended-configuration "Direct link to heading")
...
#### Existing exchange connectos[](#existing-exchange-connectos "Direct link to heading")
...
## Running the node[](#running-the-node "Direct link to heading")
...
## Governance[](#governance "Direct link to heading")
...
## Using kubernetes[](#using-kubernetes "Direct link to heading")
...
1. [One with high sampling but short timeframe](https://snapshots.raintank.io/dashboard/snapshot/sortedoracles%28public%29-now-2d?orgId=2)
2. [One with low sampling but longer timeframe](https://snapshots.raintank.io/dashboard/snapshot/sortedoracles%28public%29-now-1M?orgId=2)
