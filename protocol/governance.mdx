...
## What is Celo Governance?[](#what-is-celo-governance "Direct link to heading")
...
## Stakeholder Proposal Process[](#stakeholder-proposal-process "Direct link to heading")
...
### Overview of Phases[](#overview-of-phases "Direct link to heading")
...
### Proposal[](#proposal "Direct link to heading")
...
### Approval[](#approval "Direct link to heading")
...
### Referendum[](#referendum "Direct link to heading")
...
### Execution[](#execution "Direct link to heading")
...
## Smart Contract Upgradeability[](#smart-contract-upgradeability "Direct link to heading")
...
### Upgrade risks[](#upgrade-risks "Direct link to heading")
...
## Validator Hotfix Process[](#validator-hotfix-process "Direct link to heading")
...
## Celo Blockchain Software Upgrades[](#celo-blockchain-software-upgrades "Direct link to heading")
