...
sidebarTitle: "Ethereum Developers"
description: "Overview of the similarities and differences between the Celo and Ethereum blockchains."
---

<Tip>
  For a general overview of the Celo network and architecture, see [the Celo
  Overview page](/general).
</Tip>

## What is Celo's Relationship to Ethereum?[](#what-is-celos-relationship-to-ethereum "Direct link to heading")
...
## The ERC-20 Token Standard[](#the-erc-20-token-standard "Direct link to heading")
...
## The Celo Native Asset and the Celo Dollar[](#the-celo-native-asset-and-the-celo-dollar "Direct link to heading")
...
## Key differences between Celo and Ethereum[](#key-differences-between-celo-and-ethereum "Direct link to heading")

### Features exclusive to Celo[](#features-exclusive-to-celo "Direct link to heading")
...
### Things to watch out for[](#things-to-watch-out-for "Direct link to heading")
...
## Deploying Ethereum Contracts to Celo[](#deploying-ethereum-contracts-to-celo "Direct link to heading")
...
## Protocol Differences[](#protocol-differences "Direct link to heading")

### OPCODES & Block headers[](#opcodes--block-headers "Direct link to heading")

Celo does not support the `DIFFICULTY` or `GASLIMIT` opcodes. These fields are also absent from Celo block headers.

### Precompiled Contracts[](#precompiled-contracts "Direct link to heading")
