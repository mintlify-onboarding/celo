...
<Warning>
  Running Celo nodes and services securely, especially as part of running a
  validator, is of utmost importance. Failure to do so can lead to severe
  consequences including, but not limited to loss of funds, slashing due to
  double signing, etc.
</Warning>

### RPC Endpoints[](#rpc-endpoints "Direct link to heading")
...
### Public Endpoints[](#public-endpoints "Direct link to heading")
