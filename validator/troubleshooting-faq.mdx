...
## How do I reset my local Celo state?[](#how-do-i-reset-my-local-celo-state "Direct link to heading")
...
## How do I backup a local Celo private key?[](#how-do-i-backup-a-local-celo-private-key "Direct link to heading")
...
<Warning>
  It's important that you use a strong password to encrypt this file since it
  will be held in potentially insecure environments.
</Warning>

## How do I install and use celocli on my node?[](#how-do-i-install-and-use-celocli-on-my-node "Direct link to heading")
