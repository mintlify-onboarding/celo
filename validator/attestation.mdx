...
description: "How to configure, run, and manage an attestation service as a Celo Validator."
---
...
<Tip>
  If you have any questions or feedback after reading the documentation, please
  feel free to share them with us on GitHub: [celo-org > identity >
  Discussions](https://github.com/celo-org/identity/discussions/categories/help-q-a).
  We will happily get back to you and
</Tip>
...
<Warning>
  Failure to comply with 10DLC regulations in the US can potentially result in
  fines or blocked traffic.
</Warning>
