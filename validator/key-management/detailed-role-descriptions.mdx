...
## Celo Accounts[](#celo-accounts "Direct link to heading")
...
## Locked Gold Accounts[](#locked-gold-accounts "Direct link to heading")
...
### Creating a Locked Gold Account[](#creating-a-locked-gold-account "Direct link to heading")
...
Note that [ReleaseGold](/holder/manage/release-gold) beneficiary keys are considered vanilla Celo accounts with respect to proof-of-stake, and that the `ReleaseGold` contract address is what ultimately gets designated as a Locked Gold Account.

## Authorized Vote Signers[](#authorized-vote-signers "Direct link to heading")
...
### Authorizing a Vote Signer[](#authorizing-a-vote-signer "Direct link to heading")
...
## Authorized Validator Signers[](#authorized-validator-signers "Direct link to heading")
...
### Authorized Validator Signers for Validator Groups[](#authorized-validator-signers-for-validator-groups "Direct link to heading")
...
### Authorized Validator Signers for Validators[](#authorized-validator-signers-for-validators "Direct link to heading")
...
### Authorizing a Validator Signer[](#authorizing-a-validator-signer "Direct link to heading")
...
## Authorized Validator BLS Signers[](#authorized-validator-bls-signers "Direct link to heading")
...
### Deriving a BLS public key[](#deriving-a-bls-public-key "Direct link to heading")
...
## Authorized Attestation Signers[](#authorized-attestation-signers "Direct link to heading")
...
### Authorizing an Attestation Signer[](#authorizing-an-attestation-signer "Direct link to heading")
